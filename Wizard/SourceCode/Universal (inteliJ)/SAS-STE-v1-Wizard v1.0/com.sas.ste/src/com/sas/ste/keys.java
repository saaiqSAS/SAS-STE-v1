...
import com.sas.ste.encryptionProgram;
import com.sas.ste.layer0;
import com.sas.ste.layer1;
...
protected static String layer3out = "";
	...
	private static void encryptProcess() throws FileNotFoundException {
	 ...
	 //System.out.println("layer0out: "+processString);//test
	...
	layer0out = layer0.layer0out;
	 ...
	 /* System.out.println("layer2outCompiled: "+ layer2out); //test sout */
	...
	private static void endKey() throws FileNotFoundException {
	  encryptionProgram.goToGetFinalResult();
    }
